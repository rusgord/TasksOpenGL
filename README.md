...
<table>
  ...
  <tr>
    <td>7</td>
    <td rowspan="5">Підвищений рівень</td>
...
![Screenshot7.1 - working animation](Screenshots/Screenshot_1_lab7.png)

Рисунок 7.1 – Працююча анімація

![Screenshot7.2 - window with properties](Screenshots/Screenshot_2_lab7.png)

Рисунок 7.2 – Вікно з налаштуваннями

![Screenshot7.3 - installed screen saver ](Screenshots/Screenshot_3_lab7.png)
...
<table>
  ...
  <tr>
    <td>1</td>
    <td rowspan="4">Базовий рівень</td>
    <td>Прив’язка анімації до механізму простою операційної системи</td>
    <td>2</td>
    <td>+</td>
  </tr>
  <tr>
    <td>2</td>
    <td>Реалізація повноекранного режиму (команда «/s»)</td>
    <td>1</td>
    <td>+</td>
  </tr>
  <tr>
    <td>3</td>
    <td>Реалізація налаштування програми Screen Saver (команда «/c»)</td>
    <td>1</td>
    <td>+</td>
  </tr>
  <tr>
    <td>4</td>
    <td>Реалізація попереднього перегляду (команда «/p»)</td>
    <td>1</td>
    <td>+</td>
  </tr>
  <tr>
    <td>5</td>
    <td rowspan="5">Підвищений рівень</td>
    <td>Збереження конфігурації і налаштувань програми ScreenSaver у реєстрі ОС</td>
    <td>1</td>
    <td>+</td>
  </tr>
  <tr>
    <td>6</td>
    <td>Використання складних і видовищних алгоритмів для формування зображення (наприклад, фрактали)</td>
    <td>2</td>
    <td>+</td>
  </tr>
</table>